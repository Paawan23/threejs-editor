function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			'sidebar/material/alphamap': 'Alpha Texture',
			'sidebar/material/bumpmap': 'Bump Texture',
			'sidebar/material/normalmap': 'Normal Texture',
			'sidebar/material/clearcoatnormalmap': 'Clearcoat Normal Texture',
			'sidebar/material/displacemap': 'Displace Texture',
			'sidebar/material/roughmap': 'Rough. Texture',
			'sidebar/material/metalmap': 'Metal. Texture',
			'sidebar/material/specularmap': 'Specular Texture',
			'sidebar/material/envmap': 'Env Texture',
			'sidebar/material/lightmap': 'Light Texture',
			'sidebar/material/aomap': 'AO Texture',
			'sidebar/material/emissivemap': 'Emissive Texture',
			'sidebar/material/gradientmap': 'Gradient Texture',
